...
const AboutUs: React.FC = () => {
  return (
    <div className="crypto-site-description">
      <h2 id="crypto-site-description-heading">Ontdek alle actuele cryptocurrency-gegevens</h2>
      <p id="first-paragraph">
        Welkom op onze crypto-website, waar u alle benodigde informatie vindt over de huidige stand van de cryptocurrency-markten. Van de laatste prijzen tot marktkapitalisatie, handelsvolume en meer, bieden wij een uitgebreid overzicht van de cryptocurrency-gegevens die u nodig heeft om geïnformeerde beslissingen te nemen.
      </p>
