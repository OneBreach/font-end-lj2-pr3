...
const AboutUs: React.FC = () => {
  return (
    ...
    <div className="crypto-site-description">
      <h2>Ontdek alle actuele cryptocurrency-data</h2>
      <p>
        Welkom op onze crypto-website, waar u alle benodigde informatie vindt over de huidige stand van de cryptocurrency-markten. Van de laatste prijzen tot marktkapitalisatie, handelsvolume en meer, wij bieden een uitgebreid overzicht van de cryptocurrency-data die u nodig heeft om geïnformeerde beslissingen te nemen.
      </p>
      <p>
